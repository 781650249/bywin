...
export default function({ value: editVedioArea = [], selectedPointId = null, onChange: handleMarqueeOk = () => {} }) {
  ...
  return (
    <div className={styles.videoWrapper} style={{ height: videoHeight.current }}>
      ...
      >
        <Aliplayer id={selectedPointId} cameraId={selectedPointId} selectTime={[]} />
      </div>
    </div>
  );
}
