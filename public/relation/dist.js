  ...
  function(t, e, n) {
    ...
    s.prototype = u.prototype = {
      ...
      on: function(t, e) {
            ...
            (t + '')
              ...
              .map(function(t) {
                var e = '',
                  n = t.indexOf('.');
                if (
                  (n >= 0 && ((e = t.slice(n + 1)), (t = t.slice(0, n))), t && !i.hasOwnProperty(t))
                )
        ...
        if (!(arguments.length < 2)) {
          ...
          for (; ++o < f; )
            if ((n = (t = a[o]).type)) r[n] = l(r[n], t.name, e);
      ...
      call: function(t, e) {
        if ((n = arguments.length - 2) > 0)
          for (var n, i, r = new Array(n), a = 0; a < n; ++a) r[a] = arguments[a + 2];
    ...
    function N(t, e, n, i, r, a) {
      for (var o, f = 0, c = e.length, u = a.length; f < u; ++f)
        (o = e[f]) ? ((o.__data__ = a[f]), (i[f] = o)) : (n[f] = new k(t, a[f]));
    ...
    function A(t, e, n, i, r, a, o) {
      ...
      for (f = 0; f < h; ++f)
        (c = e[f]) &&
          ((d[f] = u = T + o.call(c, c.__data__, f, e)), u in s ? (r[f] = c) : (s[u] = c));
      for (f = 0; f < l; ++f)
        (c = s[(u = T + o.call(t, a[f], f, a))])
          ? ((i[f] = c), (c.__data__ = a[f]), (s[u] = null))
          : (n[f] = new k(t, a[f]));
    ...
    K.prototype = tt.prototype = {
      ...
      selectAll: function(t) {
        ...
        for (var e = this._groups, n = e.length, i = [], r = [], a = 0; a < n; ++a)
          for (var o, f = e[a], c = f.length, u = 0; u < c; ++u)
            (o = f[u]) && (i.push(t.call(o, o.__data__, u, f)), r.push(o));
        return new K(i, r);
      },
      filter: function(t) {
      ...
      data: function(t, e) {
        ...
        for (
          var o = a.length, f = new Array(o), c = new Array(o), u = new Array(o), s = 0;
          s < o;
          ++s
        ) {
          var h = r[s],
      ...
      merge: function(t) {
        for (
          ...
          for (
            var c, u = e[f], s = n[f], h = u.length, l = (o[f] = new Array(h)), d = 0;
            d < h;
            ++d
          )
            (c = u[d] || s[d]) && (l[d] = c);
      ...
      order: function() {
        for (var t = this._groups, e = -1, n = t.length; ++e < n; )
          for (var i, r = t[e], a = r.length - 1, o = r[a]; --a >= 0; )
            (i = r[a]) &&
              (o && 4 ^ i.compareDocumentPosition(o) && o.parentNode.insertBefore(i, o), (o = i));
        return this;
      },
      sort: function(t) {
        function e(e, n) {
    ...
    var at = function() {
      ...
      ct = function(t, e, n) {
        ...
        for (var i, r = 0, a = e ? e.length : 0; r < a; ++r)
          if ((i = e[r]).identifier === n) return ot(t, i);
        return null;
      };
    ...
    var gt = function() {
        ...
        function y() {
          if (r.apply(this, arguments)) {
            var t,
              ...
              o = n.length;
            for (t = 0; t < o; ++t)
              (e = x(n[t].identifier, i, ct, this, arguments)) && (ut(), e('start'));
          }
        }
        function v() {
          var t,
        ...
        function x(t, e, n, i, r) {
          var a,
            ...
            _ = u.copy();
          if (
            G(new _t(l, 'beforestart', a, t, s, d[0], d[1], 0, 0, _), function() {
              return (
                null != (V.subject = a = o.apply(i, r)) &&
                ((f = a.x - d[0] || 0), (h = a.y - d[1] || 0), !0)
              );
            })
          )
            return function o(u) {
              ...
              G(
                new _t(l, u, a, t, p, d[0] + f, d[1] + h, d[0] - b[0], d[1] - b[1], _),
                _.apply,
                _,
                [u, i, r],
              );
    ...
    function Dt(t) {
      ...
      return (
        ...
        (e = Nt.exec(t))
          ...
          ? Yt(parseInt(e[1], 16))
          : (e = Ct.exec(t))
          ? new Ot(e[1], e[2], e[3], 1)
          : (e = St.exec(t))
          ? new Ot((255 * e[1]) / 100, (255 * e[2]) / 100, (255 * e[3]) / 100, 1)
          : (e = Et.exec(t))
          ? qt(e[1], e[2], e[3], e[4])
          : (e = Ut.exec(t))
    ...
    function Rt(t) {
      return (
        t instanceof wt || (t = Dt(t)), t ? new Ot((t = t.rgb()).r, t.g, t.b, t.opacity) : new Ot()
      );
    }
    function jt(t, e, n, i) {
    ...
    function Ht(t, e, n, i) {
      return (
        i <= 0 ? (t = e = n = NaN) : n <= 0 || n >= 1 ? (t = e = NaN) : e <= 0 && (t = NaN),
        new Xt(t, e, n, i)
      );
    }
    function It(t, e, n, i) {
    ...
    function ee(t) {
      ...
      var n,
        ...
        a = fe(t.g),
        o = fe(t.b),
        f = re((0.2225045 * r + 0.7168786 * a + 0.0606169 * o) / Wt);
      return (
        r === a && a === o
          ? (n = i = f)
          : ((n = re((0.4360747 * r + 0.3850649 * a + 0.1430804 * o) / Zt)),
            (i = re((0.0139322 * r + 0.0971045 * a + 0.7141733 * o) / Gt))),
    ...
    function ce(t) {
      ...
      if ((t instanceof ie || (t = ee(t)), 0 === t.a && 0 === t.b))
    ...
    function we(t, e) {
      var n = e - t;
      return n
        ? me(t, n > 180 || n < -180 ? n - 360 * Math.round(n / 360) : n)
        : xe(isNaN(t) ? e : t);
    }
    function Me(t) {
      return 1 == (t = +t)
    ...
    function Ne(t) {
      return function(e) {
        var n,
          ...
          f = new Array(r);
        for (n = 0; n < r; ++n)
          (i = jt(e[n])), (a[n] = i.r || 0), (o[n] = i.g || 0), (f[n] = i.b || 0);
        return (
          (a = t(a)),
          (o = t(o)),
          (f = t(f)),
    ...
    var Ue,
      ...
      De = function(t, e) {
        var n,
          i,
          r,
          a = (Se.lastIndex = Ee.lastIndex = 0),
          o = -1,
          f = [],
          c = [];
        for (t += '', e += ''; (n = Se.exec(t)) && (i = Ee.exec(e)); )
          (r = i.index) > a && ((r = e.slice(a, r)), f[o] ? (f[o] += r) : (f[++o] = r)),
            (n = n[0]) === (i = i[0])
              ? f[o]
                ? (f[o] += i)
                : (f[++o] = i)
            ...
            (a = Ee.lastIndex);
        return (
          a < e.length && ((r = e.slice(a)), f[o] ? (f[o] += r) : (f[++o] = r)),
          f.length < 2
            ? c[0]
              ? (function(t) {
                  return function(e) {
      ...
      Re = function(t, e, n, i, r, a) {
        ...
        return (
          ...
          (f = Math.sqrt(n * n + i * i)) && ((n /= f), (i /= f), (c /= f)),
          t * i < e * n && ((t = -t), (e = -e), (c = -c), (o = -o)),
          {
            translateX: r,
            translateY: a,
    ...
    var Oe = je(
      ...
      Fe = je(
        function(t) {
          return null == t
            ? qe
            : (ze || (ze = document.createElementNS('http://www.w3.org/2000/svg', 'g')),
              ze.setAttribute('transform', t),
              (t = ze.transform.baseVal.consolidate())
                ? ((t = t.matrix), Re(t.a, t.b, t.c, t.d, t.e, t.f))
                : qe);
        },
        ', ',
        ')',
        ...
        (i = (y - b) / He),
          (n = function(t) {
            var e,
              ...
              c =
                (o / (2 * d)) *
                (f * ((e = He * n + b), ((e = Math.exp(2 * e)) - 1) / (e + 1)) -
                  (function(t) {
                    return ((t = Math.exp(t)) - 1 / t) / 2;
                  })(b));
    ...
    function $e(t) {
      return (function e(n) {
        function i(e, i) {
          ...
          return function(t) {
            return (
              (e.h = r(t)), (e.s = a(t)), (e.l = o(Math.pow(t, n))), (e.opacity = f(t)), e + ''
            );
          };
        }
          ...
          (function() {
            ...
            for (; n; )
              n._call
                ...
                : ((e = n._next), (n._next = null), (n = t ? (t._next = e) : (We = e)));
            (Ge = t), dn(i);
          })(),
          (nn = 0);
      }
    ...
    function dn(t) {
      Qe ||
        ...
        t - nn > 24
          ? (t < 1 / 0 && (Je = setTimeout(hn, t - an.now() - rn)), Ke && (Ke = clearInterval(Ke)))
          : (Ke || ((en = an.now()), (Ke = setInterval(ln, tn))), (Qe = 1), on(hn)));
    }
    un.prototype = sn.prototype = {
      ...
      restart: function(t, e, n) {
        ...
        (n = (null == n ? fn() : +n) + (null == e ? 0 : +e)),
          this._next || Ge === this || (Ge ? (Ge._next = this) : (We = this), (Ge = this)),
          (this._call = t),
          (this._time = n),
          dn();
      },
        ...
        !(function(t, e, n) {
          ...
          function a(c) {
            ...
            if (
              ...
              for (n.state = xn, i = new Array((h = n.tween.length)), u = 0, s = -1; u < h; ++u)
            ...
            for (
              var r =
                  e < n.duration
                    ...
                    : (n.timer.restart(f), (n.state = wn), 1),
                a = -1,
                o = i.length;
              ++a < o;
    ...
    var En = function(t, e) {
      var n;
      return ('number' == typeof e ? Ce : e instanceof Dt ? Te : (n = Dt(e)) ? ((e = n), Te) : De)(
        t,
        e,
      );
    };
    ...
    zn.prototype = function(t) {
      ...
      selectAll: function(t) {
        ...
        for (var i = this._groups, r = i.length, a = [], o = [], f = 0; f < r; ++f)
          for (var c, u = i[f], s = u.length, h = 0; h < s; ++h)
            if ((c = u[h])) {
              for (
                var l, d = t.call(c, c.__data__, h, u), _ = An(c, n), p = 0, b = d.length;
                p < b;
                ++p
              )
      ...
      transition: function() {
        for (
          var t = this._name, e = this._id, n = Dn(), i = this._groups, r = i.length, a = 0;
          a < r;
          ++a
        )
                ...
                ? function(t, e, n) {
                    ...
                    return function() {
                      var o,
                        ...
                        c = n(this);
                      if (null != c)
                        return (o = this.getAttributeNS(t.space, t.local)) === (f = c + '')
                          ? null
                          : o === i && f === r
                          ? a
                          : ((r = f), (a = e((i = o), c)));
        ...
        return null == e
          ? this.styleTween(
              ...
              (function(t, e) {
                ...
                return function() {
                  var a = E(this, t),
                    o = (this.style.removeProperty(t), E(this, t));
              ...
              (function(t, e, n) {
                ...
                return function() {
                  var o = E(this, t),
                    ...
                    c = f + '';
                  return (
                    null == f && (this.style.removeProperty(t), (c = f = E(this, t))),
                    o === c ? null : o === i && c === r ? a : ((r = c), (a = e((i = o), f)))
                  );
                };
              })(t, i, Sn(this, 'style.' + t, e)),
            ).each(
              (function(t, e) {
                var n,
                  i,
        ...
        return new Promise(function(a, o) {
          ...
          n.each(function() {
            var n = Nn(this, i),
              r = n.on;
            r !== t &&
              ((e = (t = r).copy())._.cancel.push(f), e._.interrupt.push(f), e._.end.push(c)),
              (n.on = e);
          });
        });
      },
    ...
    function jn(t, e) {
      for (var n; !(n = t.__transition) || !(n = n[e]); )
        if (!(t = t.parentNode)) return (Rn.time = fn()), Rn;
      return n;
    }
    (et.prototype.interrupt = function(t) {
      ...
      (et.prototype.transition = function(t) {
        ...
        t instanceof zn
          ? ((e = t._id), (t = t._name))
          : ((e = Dn()), ((n = Rn).time = fn()), (t = null == t ? null : t + ''));
    ...
    Xn.prototype = Vn.prototype = {
      ...
      bezierCurveTo: function(t, e, n, i, r, a) {
        this._ +=
          'C' + +t + ',' + +e + ',' + +n + ',' + +i + ',' + (this._x1 = +r) + ',' + (this._y1 = +a);
      },
    ...
    function oi(t) {
      ...
      return isNaN(t)
        ? 'Invalid Date'
        : ((e = t.getUTCFullYear()) < 0 ? '-' + ai(-e, 6) : e > 9999 ? '+' + ai(e, 6) : ai(e, 4)) +
            '-' +
            ai(t.getUTCMonth() + 1, 2) +
            '-' +
            ai(t.getUTCDate(), 2) +
            (a
              ? 'T' + ai(n, 2) + ':' + ai(i, 2) + ':' + ai(r, 2) + '.' + ai(a, 3) + 'Z'
              : r
              ? 'T' + ai(n, 2) + ':' + ai(i, 2) + ':' + ai(r, 2) + 'Z'
              : i || n
              ? 'T' + ai(n, 2) + ':' + ai(i, 2) + 'Z'
              : '');
    }
    var fi = function(t) {
        ...
        function i(t, e) {
            ...
            if (t.charCodeAt(r) === ti) {
              ...
              return (
                (e = o) >= a
                  ...
                  : (i = t.charCodeAt(o++)) === ei
                  ? (u = !0)
                  : i === ni && ((u = !0), t.charCodeAt(o) === ei && ++o),
                t.slice(r + 1, e - 1).replace(/""/g, '"')
              );
            }
            for (; o < a; ) {
              if ((i = t.charCodeAt((e = o++))) === ei) u = !0;
              else if (i === ni) (u = !0), t.charCodeAt(o) === ei && ++o;
          ...
          for (
            t.charCodeAt(a - 1) === ei && --a, t.charCodeAt(a - 1) === ni && --a;
            (i = s()) !== Kn;
      ...
      ci = fi(','),
      ui = ci.parse,
      si = (ci.parseRows, ci.format, ci.formatBody, ci.formatRows, fi('\t')),
      hi = si.parse;
    ...
    function _i(t) {
      return function(e, n, i) {
        return (
          2 === arguments.length && 'function' == typeof n && ((i = n), (n = void 0)),
    ...
    function gi(t, e, n, i) {
      ...
      for (; d.length; )
        if (
          ...
          return (r[h] = _), t;
      if (((f = +t._x.call(null, d.data)), (c = +t._y.call(null, d.data)), e === f && n === c))
    ...
    (Ni.copy = function() {
      var t,
        e,
        n = new ki(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
        i = this._root;
      if (!i) return n;
      ...
      (Ni.cover = function(t, e) {
        ...
        var n = this._x0,
          ...
          r = this._x1,
          a = this._y1;
        if (isNaN(n)) (r = (n = Math.floor(t)) + 1), (a = (i = Math.floor(e)) + 1);
        else {
          for (var o, f, c = r - n, u = this._root; n > t || t >= r || i > e || e >= a; )
            switch (
              ((f = ((e < i) << 1) | (t < n)), ((o = new Array(4))[f] = u), (u = o), (c *= 2), f)
            ) {
              case 0:
                (r = n + c), (a = i + c);
                break;
      ...
      (Ni.find = function(t, e, n) {
        var i,
          ...
          p = this._root;
        for (
          p && _.push(new xi(p, s, h, l, d)),
            null == n
              ? (n = 1 / 0)
              : ((s = t - n), (h = e - n), (l = t + n), (d = e + n), (n *= n));
          (c = _.pop());

        )
          if (
            !(!(p = c.node) || (r = c.x0) > l || (a = c.y0) > d || (o = c.x1) < s || (f = c.y1) < h)
          )
            if (p.length) {
              var b = (r + o) / 2,
                y = (a + f) / 2;
      ...
      (Ni.visitAfter = function(t) {
        var e,
          ...
          i = [];
        for (
          this._root && n.push(new xi(this._root, this._x0, this._y0, this._x1, this._y1));
          (e = n.pop());
    ...
    var Si = function(t) {
      ...
      function a() {
        for (var t, a, f, c, u, s, h, l = e.length, d = 0; d < r; ++d)
          for (a = Mi(e, Ai, Ci).visitAfter(o), t = 0; t < l; ++t)
            (f = e[t]),
              (s = n[f.index]),
              (h = s * s),
              (c = f.x + f.vx),
      ...
      return (
        'function' != typeof t && (t = yi(null == t ? 1 : +t)),
    ...
    var Pi = function(t) {
      ...
      function h() {
        if (i) {
          ...
          for (f = 0, a = new Array(s); f < s; ++f)
            (c = t[f]), (a[f] = r[c.source.index] / (r[c.source.index] + r[c.target.index]));
      ...
      qi = function(t) {
        ...
        function h(i) {
          ...
          for (var h = 0; h < i; ++h)
            for (
              ...
              null == (u = t[c]).fx ? (u.x += u.vx *= o) : ((u.x = u.fx), (u.vx = 0)),
                null == u.fy ? (u.y += u.vy *= o) : ((u.y = u.fy), (u.vy = 0));
          return e;
        }
        function l() {
        ...
        return (
          ...
          (e = {
            ...
            force: function(t, n) {
              return arguments.length > 1
                ? (null == n ? f.remove(t) : f.set(t, _(n)), e)
                : f.get(t);
            },
            find: function(e, n, i) {
              var r,
                ...
                u = 0,
                s = t.length;
              for (null == i ? (i = 1 / 0) : (i *= i), u = 0; u < s; ++u)
                (o = (r = e - (f = t[u]).x) * r + (a = n - f.y) * a) < i && ((c = f), (i = o));
              return c;
            },
            on: function(t, n) {
      ...
      Zi = {
        ...
        s: function(t, e) {
          ...
          return a === o
            ...
            : '0.' + new Array(1 - a).join('0') + ji(t, Math.max(0, e + a - 1))[0];
        },
        X: function(t) {
          return Math.round(t)
            .toString(16)
    ...
    (Vi = (function(t) {
        ...
        i =
          t.grouping && t.thousands
            ? ((e = t.grouping),
              ...
              function(t, i) {
                for (
                  var r = t.length, a = [], o = 0, f = e[0], c = 0;
                  r > 0 &&
                  f > 0 &&
                  (c + f + 1 > i && (f = Math.max(1, i - c)),
      ...
      function c(t) {
        var e = (t = Hi(t)).fill,
          ...
          _ = t.trim,
          p = t.type;
        'n' === p ? ((l = !0), (p = 'g')) : Zi[p] || (null == d && (d = 12), (_ = !0), (p = 'g')),
          (s || ('0' === e && '=' === n)) && ((s = !0), (e = '0'), (n = '='));
    ...
    var Nr = function(t, e, n, i, r) {
      ...
      if (
        ...
        for (var u, s, h = f[0]; ; ) {
          ...
          do {
            if (((l.v = l.o.v = !0), l.e)) {
              if (d) for (a = 0, o = u.length; a < o; ++a) r.point((s = u[a])[0], s[1]);
              else i(l.x, l.n.x, 1, r);
              l = l.n;
            } else {
              if (d) for (u = l.p.z, a = u.length - 1; a >= 0; --a) r.point((s = u[a])[0], s[1]);
    ...
    var Cr = Qi(),
      Sr = function(t, e) {
        ...
        for (var c = 0, u = t.length; c < u; ++c)
          if ((h = (s = t[c]).length))
            for (
              var s, h, l = s[h - 1], d = l[0], _ = l[1] / 2 + rr, p = dr(_), b = sr(_), y = 0;
              y < h;
              ++y, d = g, p = m, b = w, l = v
            ) {
              var v = s[y],
          ...
          var a,
            ...
            d = {
              ...
              polygonEnd: function() {
                ...
                var t = Sr(a, i);
                o.length
                  ? (l || (r.polygonStart(), (l = !0)), Nr(o, Pr, t, n, r))
                  : t &&
            ...
            if ((c.pop(), a.push(c), (c = null), d))
              if (1 & f) {
                if ((e = (n = u[0]).length - 1) > 0) {
                  for (l || (r.polygonStart(), (l = !0)), r.lineStart(), t = 0; t < e; ++t)
                    r.point((i = n[t])[0], i[1]);
                  r.lineEnd();
                }
    ...
    function Pr(t, e) {
      return (
        ((t = t.x)[0] < 0 ? t[1] - ir - er : ir - t[1]) -
        ((e = e.x)[0] < 0 ? e[1] - ir - er : ir - e[1])
      );
    }
    Er(
      function() {
              ...
              : r !== f &&
                ...
                (i = (function(t, e, n, i) {
                  var r,
                    ...
                    o = dr(t - n);
                  return fr(o) > er
                    ? cr((dr(e) * (a = sr(i)) * dr(n) - dr(i) * (r = sr(e)) * dr(t)) / (r * a * o))
                    : (e + i) / 2;
                })(n, i, a, o)),
                t.point(r, i),
                t.lineEnd(),
    ...
    function Wr(t, e) {
      var n = yr(Zr * dr(e)),
        ...
        r = i * i * i;
      return [
        (t * sr(n)) / (Zr * (Xr + 3 * Vr * i + r * (7 * Br + 9 * $r * i))),
        n * (Xr + Vr * i + r * (Br + $r * i)),
      ];
    }
    Wr.invert = function(t, e) {
      for (
        var n, i = e, r = i * i, a = r * r * r, o = 0;
        o < 12 &&
        ((a =
          (r =
            (i -= n =
              (i * (Xr + Vr * r + a * (Br + $r * r)) - e) /
              (Xr + 3 * Vr * r + a * (7 * Br + 9 * $r * r))) * i) *
          r *
          r),
        !(fr(n) < 1e-12));
        ++o
    ...
    Qr.invert = function(t, e) {
      ...
      do {
        var a = i * i,
          o = a * a;
        i -= n =
          (i * (1.007226 + a * (0.015085 + o * (0.028874 * a - 0.044475 - 0.005916 * o))) - e) /
          (1.007226 + a * (0.045255 + o * (0.259866 * a - 0.311325 - 0.005916 * 11 * o)));
      } while (fr(n) > er && --r > 0);
      return [
        t /
          (0.8707 +
            (a = i * i) * (a * (a * a * a * (0.003971 - 0.001529 * a) - 0.013791) - 0.131979)),
        i,
      ];
    };
    ...
    function na(t, e) {
      ...
      for (null == e && (e = ia); (n = u.pop()); )
        if ((c && (n.value = +n.data.value), (r = e(n.data)) && (o = r.length)))
          for (n.children = new Array(o), a = o - 1; a >= 0; --a)
            u.push((i = n.children[a] = new oa(r[a]))), (i.parent = n), (i.depth = n.depth + 1);
      ...
      each: function(t) {
        ...
        do {
          for (e = o.reverse(), o = []; (a = e.pop()); )
            if ((t(a), (n = a.children))) for (i = 0, r = n.length; i < r; ++i) o.push(n[i]);
        } while (o.length);
        return this;
      },
      eachAfter: function(t) {
        for (var e, n, i, r = this, a = [r], o = []; (r = a.pop()); )
          if ((o.push(r), (e = r.children))) for (n = 0, i = e.length; n < i; ++n) a.push(e[n]);
        for (; (r = o.pop()); ) t(r);
        return this;
      },
      eachBefore: function(t) {
        for (var e, n, i = this, r = [i]; (i = r.pop()); )
          if ((t(i), (e = i.children))) for (n = e.length - 1; n >= 0; --n) r.push(e[n]);
        return this;
      },
      sum: function(t) {
    ...
    var fa = function(t, e, n, i, r) {
      for (var a, o = t.children, f = -1, c = o.length, u = t.value && (i - e) / t.value; ++f < c; )
        ((a = o[f]).y0 = n), (a.y1 = r), (a.x0 = e), (a.x1 = e += a.value * u);
    };
    ...
    var ua = function(t, e, n, i, r) {
        for (
          var a, o = t.children, f = -1, c = o.length, u = t.value && (r - n) / t.value;
          ++f < c;

        )
          ((a = o[f]).x0 = e), (a.x1 = i), (a.y0 = n), (a.y1 = n += a.value * u);
      },
      sa = (1 + Math.sqrt(5)) / 2;
    ...
    function ha(t, e, n, i, r, a) {
      for (
        ...
        for (
          h = l = s, b = s * s * (p = Math.max(u / c, c / u) / (w * t)), _ = Math.max(l / b, b / h);
          x < m;
          ++x
        ) {
          if (
        ...
        y.push(
          ...
          o.dice
            ? fa(o, n, i, r, w ? (i += (u * s) / w) : a)
            : ua(o, n, i, w ? (n += (c * s) / w) : r, a),
          (w -= s),
          (g = x);
      }
      return y;
        ...
        function n(t, n, i, r, a) {
          if ((o = t._squarify) && o.ratio === e)
            for (var o, f, c, u, s, h = -1, l = o.length, d = t.value; ++h < l; ) {
              for (c = (f = o[h]).children, u = f.value = 0, s = c.length; u < s; ++u)
                f.value += c[u].value;
              f.dice
                ? fa(f, n, i, r, (i += ((a - i) * f.value) / d))
                : ua(f, n, i, (n += ((r - n) * f.value) / d), a),
                (d -= f.value);
            }
        ...
        function k(t, e, n, i) {
          for (var r, a, o = 0, f = e.length, c = n.length; o < f; ) {
            ...
            if (37 === (r = e.charCodeAt(o++))) {
              if (
                ((r = e.charAt(o++)), !(a = m[r in ao ? e.charAt(o++) : r]) || (i = a(t, n, i)) < 0)
              )
                return -1;
    ...
    vf(
      ...
      Ze(ye(300, 0.5, 0), ye(-240, 0.5, 1)),
      Ze(ye(-100, 0.75, 0.35), ye(80, 1.5, 0.8)),
      Ze(ye(260, 0.75, 0.35), ye(80, 1.5, 0.8)),
      ye(),
      jt(),
      Math.PI,
      Math.PI;
          ...
          for (var i, r = t[0], a = e[0], o = t[n] - r, f = e[n] - a, c = -1; ++c <= n; )
            (i = c / n),
              this._basis.point(
                ...
                this._beta * e[c] + (1 - this._beta) * (a + i * f),
              );
    ...
    function Xf(t, e, n) {
      var i = t._x1 - t._x0,
        ...
        o = (n - t._y1) / (r || (i < 0 && -0)),
        f = (a * r + o * i) / (i + r);
      return (If(a) + If(o)) * Math.min(Math.abs(a), Math.abs(o), 0.5 * Math.abs(f)) || 0;
    }
    function Vf(t, e) {
      var n = t._x1 - t._x0;
    ...
    function Qf(t) {
      ...
      for (r[i - 1] = 2, a[i - 1] = 7, o[i - 1] = 8 * t[i - 1] + t[i], e = 1; e < i; ++e)
        ...
        lineEnd: function() {
          ...
          if (n)
            if (
              ...
              for (var i = Qf(t), r = Qf(e), a = 0, o = 1; o < n; ++a, ++o)
    ...
    Kf.prototype = {
      ...
      insert: function(t, e) {
        ...
        if (t) {
          ...
          this._
            ? ((t = ic(this._)), (e.P = null), (e.N = t), (t.P = t.L = e), (n = t))
            : ((e.P = e.N = null), (this._ = e), (n = null));
        for (e.L = e.R = null, e.U = n, e.C = !0, t = e; n && n.C; )
          n === (i = n.U).L
            ? (r = i.R) && r.C
              ? ((n.C = r.C = !1), (i.C = !0), (t = i))
              : (t === n.R && (ec(this, n), (n = (t = n).U)), (n.C = !1), (i.C = !0), nc(this, i))
            : (r = i.L) && r.C
            ? ((n.C = r.C = !1), (i.C = !0), (t = i))
            : (t === n.L && (nc(this, n), (n = (t = n).U)), (n.C = !1), (i.C = !0), ec(this, i)),
            (n = t.U);
        this._.C = !1;
      },
      remove: function(t) {
        ...
        if (
          ...
          a && o
            ? ((i = n.C),
              ...
              (a.U = n),
              n !== o
                ? ((r = n.U), (n.U = t.U), (t = n.R), (r.L = t), (n.R = o), (o.U = n))
                : ((n.U = r), (r = n), (t = n.R)))
            : ((i = t.C), (t = n)),
          t && (t.U = r),
          !i)
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === r.L) {
                if (
                  ((e = r.R).C && ((e.C = !1), (r.C = !0), ec(this, r), (e = r.R)),
                  (e.L && e.L.C) || (e.R && e.R.C))
                ) {
                  (e.R && e.R.C) || ((e.L.C = !1), (e.C = !0), nc(this, e), (e = r.R)),
                    (e.C = r.C),
                    (r.C = e.R.C = !1),
                    ec(this, r),
                    (t = this._);
                ...
                ((e = r.L).C && ((e.C = !1), (r.C = !0), nc(this, r), (e = r.L)),
                (e.L && e.L.C) || (e.R && e.R.C))
              ) {
                (e.L && e.L.C) || ((e.R.C = !1), (e.C = !0), ec(this, e), (e = r.L)),
                  (e.C = r.C),
                  (r.C = e.L.C = !1),
                  nc(this, r),
                  (t = this._);
    ...
    function uc(t, e, n, i, r) {
      ...
      } else if (((f = b - (o = (h - d) / (_ - l)) * p), o < -1 || o > 1))
        if (h > d) {
          if (c) {
            if (c[1] >= r) return;
          } else c = [(n - f) / o, n];
    ...
    function kc(t, e) {
      ...
      var s = f - i,
        ...
        l = s / u;
      return h
        ? (-l + Math.sqrt(l * l - 2 * h * ((s * s) / (-2 * u) - c + u / 2 + r - a / 2))) / h + i
        : (i + f) / 2;
    }
    function Tc(t, e) {
      var n = t.N;
    ...
    function Lc(t, e) {
      var n,
        ...
        r,
        a = t.sort(Pc).pop();
      for (Sc = [], Ac = new Array(t.length), Nc = new rc(), Cc = new rc(); ; )
        if (((r = dc), a && (!r || a[1] < r.y || (a[1] === r.y && a[0] < r.x))))
          (a[0] === n && a[1] === i) || (Mc(a), (n = a[0]), (i = a[1])), (a = t.pop());
        else {
          if (!r) break;
          wc(r.arc);
        }
      if (
        ...
        !(function(t, e, n, i) {
          for (var r, a = Sc.length; a--; )
            (uc((r = Sc[a]), t, e, n, i) &&
              cc(r, t, e, n, i) &&
              (Math.abs(r[0][0] - r[1][0]) > Ec || Math.abs(r[0][1] - r[1][1]) > Ec)) ||
              delete Sc[a];
        })(o, f, c, u),
          (function(t, e, n, i) {
            var r,
              ...
              if ((a = Ac[r])) {
                ...
                for (f = 0, u = c.length; f < u; )
                  (_ = (d = lc(a, Sc[c[f]]))[0]),
                    ...
                    (h = (s = hc(a, Sc[c[++f % u]]))[0]),
                    (l = s[1]),
                    (Math.abs(_ - h) > Ec || Math.abs(p - l) > Ec) &&
                      (c.splice(
                        f,
                        0,
                        Sc.push(
                          oc(
                            o,
                            d,
                            Math.abs(_ - t) < Ec && i - p > Ec
                              ? [t, Math.abs(h - t) < Ec ? l : i]
                              : Math.abs(p - i) < Ec && n - _ > Ec
                              ? [Math.abs(l - i) < Ec ? h : n, i]
                              : Math.abs(_ - n) < Ec && p - e > Ec
                              ? [n, Math.abs(h - n) < Ec ? l : e]
                              : Math.abs(p - e) < Ec && _ - t > Ec
                              ? [Math.abs(l - e) < Ec ? h : t, e]
                              : null,
                          ),
                        ) - 1,
                      ),
            ...
            if (y) {
              var v,
                ...
                x,
                m = 1 / 0;
              for (r = 0, y = null; r < b; ++r)
                (a = Ac[r]) &&
                  (x = (v = (o = a.site)[0] - t) * v + (g = o[1] - e) * g) < m &&
                  ((m = x), (y = a));
              if (y) {
                var w = [t, e],
                  M = [t, i],
              ...
              for (
                ...
                (o = d),
                  ...
                  o &&
                    ...
                    ((c = o),
                    (u = d),
                    ((f = s)[0] - u[0]) * (c[1] - f[1]) - (f[0] - c[0]) * (u[1] - f[1]) < 0) &&
    ...
    var Bc = function() {
        ...
        if (n.apply(this, arguments)) {
          ...
          if (t.wheel)
            (t.mouse[0][0] === o[0] && t.mouse[0][1] === o[1]) ||
              (t.mouse[1] = e.invert((t.mouse[0] = o))),
            ...
            i = nt(V.view)
              .on(
                ...
                function() {
                  ...
                  t.zoom(
                    'mouse',
                    r(g(t.that.__zoom, (t.mouse[0] = ft(t.that)), t.mouse[1]), t.extent, c),
                  );
                },
                !0,
              )
        ...
        if (n.apply(this, arguments)) {
          ...
          for (Rc(), i = 0; i < c; ++i)
            (r = f[i]),
              ...
              o.touch0 ? o.touch1 || (o.touch1 = a) : ((o.touch0 = a), (e = !0));
          if (t && ((t = clearTimeout(t)), !o.touch1))
            return o.end(), void ((a = nt(this).on('dblclick.zoom')) && a.apply(this, arguments));
          e &&
      ...
      function C() {
        var e,
          ...
          f = V.changedTouches,
          u = f.length;
        for (jc(), t && (t = clearTimeout(t)), e = 0; e < u; ++e)
          (n = f[e]),
            (i = ct(this, f, n.identifier)),
            o.touch0 && o.touch0[2] === n.identifier
              ? (o.touch0[0] = i)
              : o.touch1 && o.touch1[2] === n.identifier && (o.touch1[0] = i);
      ...
      function S() {
        ...
        for (
          ...
          (n = r[t]),
            i.touch0 && i.touch0[2] === n.identifier
              ? delete i.touch0
              : i.touch1 && i.touch1[2] === n.identifier && delete i.touch1;
      ...
      return (
        ...
        (M.prototype = {
          start: function() {
            return (
              1 == ++this.active && ((this.index = h.push(this) - 1), this.emit('start')), this
            );
          },
          zoom: function(t, e) {
            return (
            ...
            return (
              0 == --this.active && (h.splice(this.index, 1), (this.index = -1), this.emit('end')),
              this
            );
          },
          emit: function(t) {
        ...
        (y.extent = function(t) {
          return arguments.length
            ? ((i = 'function' == typeof t ? t : zc([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]])),
              y)
            : i;
        }),
  ...
  function(t, e, n) {
    ...
    n.r(e),
      function(t) {
              ...
              (n = [
                {
                  ...
                  value: function() {
                    ...
                    (this.simulation = i
                      .g(this.config.nodes)
                      .force('link', i.e(this.config.links))
                      .force('charge', i.f().strength(this.config.chargeStrength))
                      .force('center', i.c(this.config.width / 2, this.config.height / 2))
                      .force(
                        'collide',
                        i
                          .d(this.config.collide)
                          .strength(0.2)
                          .iterations(5),
                      )
                      ...
                      (this.edges = this.relMap_g
                        ...
                        .on('click', function(t) {
                          localStorage.setItem('lineClick', t);
                          // this.edges.selectAll("path.links").attr("stroke-width", 1)
                          // i.h(this).selectAll("path.links").attr("stroke-width", 5)
                          console.log('线click', t);
                        })
                      ...
                      (this.circles = this.relMap_g
                        ...
                        .on('click', function(t) {
                          localStorage.setItem('headIconClick', t);
                          console.log('头像节点click', t), (event = i.b || window.event);
                          event.pageX
                            ? event.pageX
                            : (event.clientX,
                          ...
                          i
                            ...
                            .on('start', function(e) {
                              i.b.sourceEvent.stopPropagation(),
                                i.b.active || t.simulation.alphaTarget(0.3).restart(),
                                (e.fx = e.x),
                                (e.fy = e.y);
                            })
                            .on('drag', function(t) {
                    ...
                    this.edges.attr('transform', function(t) {
                      return (
                        ...
                        n.x > e.x
                          ? (r =
                              n.y > e.y
                                ? Math.asin((n.y - e.y) / i)
                                : -(r = Math.asin((e.y - n.y) / i)))
                          : n.y > e.y
                          ? ((r = Math.asin((n.y - e.y) / i)), (r = Math.PI - r))
                          : ((r = Math.asin((e.y - n.y) / i)), (r -= Math.PI)),
                        (r *= 180 / Math.PI),
                      ...
                      this.texts
                        ...
                        .attr('transform', function(t) {
                          return t.target.x < t.source.x
                            ? 'rotate(180 ' + o(t.source, t.target) / 2 + ' 0)'
                            : 'rotate(0)';
                        }),
                    ...
                    if (t) {
                      ...
                      (this.dependsNode = this.dependsNode.concat([n])),
                        ...
                        this.config.links.forEach(function(t) {
                          n == t.source.index
                            ? (e.dependsNode = e.dependsNode.concat([t.target.index]))
                            : n == t.target.index &&
                              (e.dependsNode = e.dependsNode.concat([t.source.index]));
                        }),
                        ...
                        this.SVG.selectAll('.edge')
                          .filter(function(t) {
                            return (
                              -1 == e.dependsLinkAndText.indexOf(t.source.index) &&
                              -1 == e.dependsLinkAndText.indexOf(t.target.index)
                            );
                          })
                          .transition()
                          .style('opacity', 0.1);
        ...
        (f = void 0),
          (c = s),
          'object' === ('undefined' == typeof exports ? 'undefined' : r(exports)) && void 0 !== t
            ? (t.exports = c)
            : ((f = f || self).RelationChart = c);
      }.call(this, n(2)(t));
  },
